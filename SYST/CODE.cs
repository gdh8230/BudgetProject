...
namespace SYST
{
    public partial class CODE : frmSub_Baseform_Search_STD
    {
        public CODE()
        {
            InitializeComponent();
        ...
        private void getData()
        {
            try
            {
                ...
                //dt = df_select(1, null, out error_msg);
                //if (dt == null)
                //{
                //    MsgBox.MsgErr("코드 정보를 가져오는데 실패 했습니다.\r\n" + error_msg, "에러");
                //    this.Cursor = Cursors.Default;
        ...
        private DataSet df_select(int Index, object[] Param, out string error_msg)
        {
            ...
            switch (Index)
            {
                case 0: //코드구분 조회
                    {
                        string query = "SELECT DISTINCT C_ID FROM TS_CODE WITH(NOLOCK)";
        ...
        private bool df_Transaction(int Index, object[] Param, DataRow dr, out string error_msg)
        {
            ...
            try
            {
                ...
                {
                    gConst.DbConn.ProcedureName = "USP_SYS_SET_CODE";
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ds_004.HasChanges())
                {
                    ...
                    {
                        gParam = new string[] { dr_h["C_ID"].ToString() };
        ...
        private void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            ds_003 = df_select(1, new string[] { dr["C_ID"].ToString() }, out error_msg);
            if (ds_003 == null)
            {
                MsgBox.MsgErr("코드 정보를 가져오는데 실패 했습니다.\r\n" + error_msg, "에러");
                this.Cursor = Cursors.Default;
